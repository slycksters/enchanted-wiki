...
export const EQUIPS_OVERVIEW = {
  ...
  intro: [
    "Equips define the core combat mechanics of your character in the game. They determine your fighting style, damage output, and special effects.",
    "Below is a breakdown of each type and how they influence gameplay."
  ]
};

export const EQUIPS_SECTIONS = [
  {
    title: "Specs",
    description: [
