...
const raceAssets = assets.images.races;

export const RACES = {
  human: {
    id: 1,
    attachment: raceAssets.human,
    description:
  ...
  fullbringer: {
    id: 11,
    attachment: raceAssets.fullbringer,
    description:
